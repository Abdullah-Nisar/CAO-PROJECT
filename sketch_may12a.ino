...
void loop() {
  ...
  time_hour_1 = (String(PARAM_INPUT_1[0]) + String(PARAM_INPUT_1[1])).toInt();
  time_minute_1 = (String(PARAM_INPUT_1[3]) + String(PARAM_INPUT_1[4])).toInt();
  total_time_in_ms_1 = (time_hour_1 * 3600 + time_minute_1 * 60) * 1000;
